...
{{< figure src="/images/posts/language-model/awd-arch.png" alt="AWD LSTM Architecture" >}}
...
{{< figure src="/images/posts/language-model/conversation-dist.png" alt="Conversation Dataset Distribution" width="330px" height="200px" >}}
...
{{< figure src="/images/posts/language-model/wiki-dist.png" alt="Wikipedia Dataset Distribution" >}}
...
{{< figure src="/images/posts/language-model/ppl-form.png" alt="Perplexity Formula" >}}
...
{{< figure src="/images/posts/language-model/word-lm-conv-result.png" alt="Word-level Language Model Results on Conversational Dataset" >}}

Experiment on id-wikipedia

{{< figure src="/images/posts/language-model/word-lm-wiki-result.png" alt="Word-level Language Model Results on Wikipedia Dataset" >}}
...
{{< figure src="/images/posts/language-model/char-lm-conv-result.png" alt="Character-level Language Model Results on Conversational Dataset" >}}
